...
ModuleBase::matrix ModuleIO::cal_mulliken_k(const std::vector<std::vector<std::complex<double>>> &dm,
    LCAO_Matrix* LM, const K_Vectors& kv, hamilt::Hamilt* ham_in
)
{
...
void ModuleIO::out_mulliken(const int& step, LCAO_Matrix *LM, const elecstate::ElecState* pelec, const K_Vectors& kv, hamilt::Hamilt* ham_in)
{
