...
template struct cast_memory<float, float, DEVICE_GPU, DEVICE_GPU>;
template struct cast_memory<double, double, DEVICE_GPU, DEVICE_GPU>;
template struct cast_memory<float, double, DEVICE_GPU, DEVICE_GPU>;
template struct cast_memory<double, float, DEVICE_GPU, DEVICE_GPU>;
template struct cast_memory<std::complex<float>, std::complex<float>, DEVICE_GPU, DEVICE_GPU>;
template struct cast_memory<std::complex<double>, std::complex<double>, DEVICE_GPU, DEVICE_GPU>;
template struct cast_memory<std::complex<float>, std::complex<double>, DEVICE_GPU, DEVICE_GPU>;
template struct cast_memory<std::complex<double>, std::complex<float>, DEVICE_GPU, DEVICE_GPU>;
template struct cast_memory<float, float, DEVICE_GPU, DEVICE_CPU>;
template struct cast_memory<double, double, DEVICE_GPU, DEVICE_CPU>;
template struct cast_memory<float, double, DEVICE_GPU, DEVICE_CPU>;
template struct cast_memory<double, float, DEVICE_GPU, DEVICE_CPU>;
template struct cast_memory<std::complex<float>, std::complex<float>, DEVICE_GPU, DEVICE_CPU>;
template struct cast_memory<std::complex<double>, std::complex<double>, DEVICE_GPU, DEVICE_CPU>;
template struct cast_memory<std::complex<float>, std::complex<double>, DEVICE_GPU, DEVICE_CPU>;
template struct cast_memory<std::complex<double>, std::complex<float>, DEVICE_GPU, DEVICE_CPU>;
template struct cast_memory<float, float, DEVICE_CPU, DEVICE_GPU>;
template struct cast_memory<double, double, DEVICE_CPU, DEVICE_GPU>;
template struct cast_memory<float, double, DEVICE_CPU, DEVICE_GPU>;
template struct cast_memory<double, float, DEVICE_CPU, DEVICE_GPU>;
template struct cast_memory<std::complex<float>, std::complex<float>, DEVICE_CPU, DEVICE_GPU>;
template struct cast_memory<std::complex<double>, std::complex<double>, DEVICE_CPU, DEVICE_GPU>;
template struct cast_memory<std::complex<float>, std::complex<double>, DEVICE_CPU, DEVICE_GPU>;
template struct cast_memory<std::complex<double>, std::complex<float>, DEVICE_CPU, DEVICE_GPU>;
