...
TEST_F(PWTEST,test_big)
{
    ...
    ModulePW::PW_Basis_Big pwtest(GlobalV::device_flag, GlobalV::precision_flag);
    ModulePW::PW_Basis_K_Big pwktest(GlobalV::device_flag, GlobalV::precision_flag);
    ...
    delete[] kvec_d;
    ModulePW::PW_Basis_Big *p_pw = new ModulePW::PW_Basis_Big(GlobalV::device_flag, GlobalV::precision_flag);
    ModulePW::PW_Basis_K_Big *p_pwk = new ModulePW::PW_Basis_K_Big(GlobalV::device_flag, GlobalV::precision_flag);
    delete p_pw;
    delete p_pwk;
    fftw_cleanup();
