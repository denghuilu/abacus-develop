...
template <typename T>
void HSolverLCAO<T>::solveTemplate(hamilt::Hamilt* pHamilt,
                                psi::Psi<T>& psi,
...
template <typename T>
void HSolverLCAO<T>::solve(hamilt::Hamilt* pHamilt,
    psi::Psi<T>& psi,
    elecstate::ElecState* pes,
    const std::string method_in,
    const bool skip_charge)
...
template <typename T>
void HSolverLCAO<T>::hamiltSolvePsiK(hamilt::Hamilt* hm, psi::Psi<T>& psi, double* eigenvalue)
{
