...
{
public:
    hsolver::HSolver hs_cf;
    hsolver::HSolver hs_cd;
    hsolver::HSolver hs_f;
    hsolver::HSolver hs_d;

    hamilt::Hamilt hamilt_test_cd;
    hamilt::Hamilt hamilt_test_cf;
	psi::Psi<std::complex<double>> psi_test_cd;
    psi::Psi<std::complex<float>> psi_test_cf;

    hamilt::Hamilt hamilt_test_d;
