...
void LCAO_Hamilt::calculate_HSR_sparse(const int &current_spin, const double &sparse_threshold, const int (&nmp)[3], hamilt::Hamilt* p_ham)
{
...
void LCAO_Hamilt::calculate_SR_sparse(const double &sparse_threshold, hamilt::Hamilt* p_ham)
{
