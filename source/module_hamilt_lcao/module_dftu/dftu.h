...
class DFTU
{
  ...
  public:
    ...
    void cal_occup_m_k(const int iter, const std::vector<std::vector<std::complex<double>>>& dm_k, const K_Vectors& kv, const double& mixing_beta, hamilt::Hamilt* p_ham);
  ...
  private:
    ...
    */
   void folding_matrix_k_new(const int ik, hamilt::Hamilt* p_ham);
